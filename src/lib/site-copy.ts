...
const siteCopy: Record<SiteLanguage, SiteCopy> = {
  en: {
    ...
    footer: {
      ...
      instagramHandle: "api_culture_technology",
  ...
  te: {
    ...
    home: {
      ...
      stats: ["సంవత్సరాల అనుభవం", "తేనెటీగల పెంపకదారులు", "ప్రాయోగిక శిక్షణ", "సంస్థాగత మద్దతు"],
  ...
  hi: {
    ...
    home: {
      ...
      stats: ["अनुभव के वर्ष", "मधुमक्खी पालक", "व्यावहारिक प्रशिक्षण", "संस्थागत सहयोग"],
