  ...
  const copy = {
    ...
    hi: {
      ...
      items: {
        Honey: {
          title: "शहद",
          description: "सबसे परिचित हाइव उत्पाद, जो कॉलोनी स्वास्थ्य, फूलों के स्रोत, स्वच्छ कटाई और मूल्य-वर्धित पैकिंग से जुड़ता है.",
          highlights: ["सही हाइव प्रबंधन के बाद कटाई", "फिल्टरिंग, स्वच्छता और बॉटलिंग से जुड़ा", "आजीविका और बाजार मूल्य-वर्धन में मदद"],
        },
        "Royal Jelly": {
          title: "रॉयल जेली",
          description: "एक विशेष उच्च-मूल्य बी-प्रोडक्ट, जो क्वीन सेल तैयारी, सही संग्रह समय, सावधानीपूर्ण ट्रांसफर और संवेदनशील हैंडलिंग पर निर्भर करता है.",
          highlights: ["तैयार क्वीन सेल से संग्रह", "सटीक समय की जरूरत", "नाजुक मूल्य-वर्धित बी-प्रोडक्ट की तरह हैंडलिंग"],
        },
        "Bee Pollen": {
          title: "बी पोलन",
          description: "पोलन ट्रैपिंग से संग्रहित उत्पाद, जिसे सफाई, ड्राइंग जागरूकता, स्टोरेज और प्रस्तुति के लिए संभाला जाता है.",
          highlights: ["पोलन ट्रैप से संग्रह", "संग्रह के बाद साफ हैंडलिंग जरूरी", "मूल्य-वर्धित हाइव उत्पाद के रूप में पैक किया जा सकता है"],
        },
        Beeswax: {
          title: "बीज़वैक्स",
          description: "हाइव कार्यों से प्राप्त वैक्स, जिसे साफ, प्रोसेस, मोल्ड या फाउंडेशन से जुड़े कामों और अन्य उत्पाद धाराओं में उपयोग किया जा सकता है.",
          highlights: ["हाइव सामग्री से प्राप्त", "मेल्टिंग और सफाई से प्रोसेस", "रीयूज और उत्पाद विविधता में मदद"],
        },
        Propolis: {
          title: "प्रोपोलिस",
          description: "रेजिनस हाइव उत्पाद, जिसे नियंत्रित संग्रह तरीकों और बुनियादी सफाई या अलगाव प्रक्रियाओं से प्राप्त किया जाता है.",
          highlights: ["विशेष तरीकों से संग्रह", "सफाई और हैंडलिंग जागरूकता जरूरी", "हाइव-प्रोडक्ट विविधता बढ़ाता है"],
        },
        "Bee Venom": {
          title: "बी वेनम",
          description: "विशेष उत्पाद धारा, जिसमें नियंत्रित तरीके, उपकरण जागरूकता और अनुशासित सुरक्षा अभ्यास जरूरी हैं.",
          highlights: ["विशेष संग्रह वर्कफ्लो", "सुरक्षा पर मजबूत फोकस", "उन्नत उत्पाद विविधता से परिचय"],
        },
