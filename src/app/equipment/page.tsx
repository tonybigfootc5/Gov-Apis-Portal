      ...
      <div className="mx-auto max-w-7xl">
        <div className="relative overflow-hidden rounded-[2.35rem] border border-[rgba(41,56,49,0.1)] bg-[#fffefa] shadow-[0_30px_90px_rgba(121,105,70,0.16)]">
          ...
          <div className="relative grid min-h-[43rem] grid-rows-[auto_1fr] gap-5 p-5 sm:p-8 lg:p-10">
            <header className="grid gap-5 lg:grid-cols-[11rem_minmax(0,1fr)_18rem] lg:items-start">
              <Link href="/" className="flex h-20 w-20 items-center justify-center rounded-full border border-[rgba(31,53,43,0.12)] bg-white shadow-[0_18px_42px_rgba(121,105,70,0.12)]" aria-label="API CULTURE home">
                <Image src="/api-culture-logo-clean.png" alt="API CULTURE logo" width={56} height={56} className="h-14 w-14 object-contain" priority />
              </Link>
              ...
              <div className="flex items-center justify-start gap-3 lg:justify-end">
                ...
                <span className="text-[11px] font-black uppercase tracking-[0.22em] text-[#133226]">Equipment groups</span>
              </div>
            </header>
            ...
            <div className="grid gap-8 lg:grid-cols-[15rem_minmax(0,1fr)_17rem] lg:items-center">
              ...
              <aside className="order-2 space-y-5 lg:order-3">
                <div className="rounded-[1.4rem] border border-[rgba(41,56,49,0.08)] bg-white/80 p-5 shadow-[0_18px_46px_rgba(121,105,70,0.1)]">
                  <p className="text-[11px] font-black uppercase tracking-[0.22em] text-[#b36b00]">Supply scope</p>
                  <div className="mt-4 flex flex-wrap gap-2">
                    {equipmentList.map((item) => (
                      <span key={item} className="rounded-full bg-[#f5efe4] px-3 py-2 text-[11px] font-bold text-[#52695e]">
                        {item}
                      </span>
                    ))}
                  </div>
